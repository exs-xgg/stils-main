...
if (isset($_POST['submit'])) {
	if (isset($_POST['item_name'])) {
		...
		$sql = "insert into item (supplier, serial_no, item_name, unit_price, init_qty, qty,date_added,date_last_update) values($supplier_id,'$serial','$item_name',$item_price,$item_qty,$item_qty,CONVERT_TZ(current_timestamp(),'+0:00','+08:00'),CONVERT_TZ(current_timestamp(),'+0:00','+08:00'))";
